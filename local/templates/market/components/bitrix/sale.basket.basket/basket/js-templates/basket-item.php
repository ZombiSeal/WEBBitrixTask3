...
<script id="basket-item-template" type="text/html">
                            ...
                            <div class="card-info__select size-select card-info__size-select"
                                ...
                                <ul class="size-select__list">
                                    ...
                                    <li class="size-select__ite{{#NOT_AVAILABLE_OFFER}} not-available{{/NOT_AVAILABLE_OFFER}}"
                                        ...
                                        data-sku-name="{{NAME}}"
                                        data-property="{{PROP_CODE}}">
                                        <button class="size-select__btn{{#SELECTED}} size-select__btn--active{{/SELECTED}}">{{NAME}}</button>
                                    </li>
                                    {{/SKU_VALUES_LIST}}
                                </ul>
    ...
    <!--						<div>-->
    <!--							--><?php //=Loc::getMessage('SBB_GOOD_CAP')?><!-- <strong>{{NAME}}</strong> --><?php //=Loc::getMessage('SBB_BASKET_ITEM_DELETED')?><!--.-->
    <!--						</div>-->
    <!--						<div class="basket-items-list-item-removed-block">-->
    <!--							<a href="javascript:void(0)" data-entity="basket-item-restore-button">-->
    <!--								--><?php //=Loc::getMessage('SBB_BASKET_ITEM_RESTORE')?>
    <!--							</a>-->
    ...
    //					{
    //						?>
    <!--						<div class="basket-item-block-image--><?php //=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' d-none d-sm-block' : '')?><!--">-->
    <!--							{{#DETAIL_PAGE_URL}}-->
    <!--								<a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link">-->
    <!--							{{/DETAIL_PAGE_URL}}-->
    <!---->
    <!--							<img class="basket-item-image" alt="{{NAME}}"-->
    <!--								src="{{{IMAGE_URL}}}{{^IMAGE_URL}}--><?php //=$templateFolder?><!--/images/no_photo.png{{/IMAGE_URL}}">-->
    <!---->
    <!--							{{#SHOW_LABEL}}-->
    <!--								<div class="basket-item-label-text basket-item-label-big --><?php //=$labelPositionClass?><!--">-->
    <!--									{{#LABEL_VALUES}}-->
    ...
    <!--									<div class="basket-item-label-ring basket-item-label-small --><?php //=$discountPositionClass?><!--">-->
    ...
    <!--									--><?php //=Loc::getMessage('SBB_BASKET_ITEM_NOT_AVAILABLE')?><!--.-->
    <!--								</div>-->
    <!--							</div>-->
    <!--						{{/NOT_AVAILABLE}}-->
    <!--						{{#DELAYED}}-->
    <!--							<div class="basket-items-list-item-warning-container">-->
    <!--								<div class="alert alert-warning text-center">-->
    <!--									--><?php //=Loc::getMessage('SBB_BASKET_ITEM_DELAYED')?><!--.-->
    <!--									<a href="javascript:void(0)" data-entity="basket-item-remove-delayed">-->
    <!--										--><?php //=Loc::getMessage('SBB_BASKET_ITEM_REMOVE_DELAYED')?>
    <!--									</a>-->
    <!--								</div>-->
    <!--							</div>-->
    <!--						{{/DELAYED}}-->
    ...
    //												?>
    <!--												{{#PROPS}}-->
    <!--													<div class="basket-item-property--><?php //=(!isset($mobileColumns['PROPS']) ? ' d-none d-sm-block' : '')?><!--">-->
    ...
    <!--																data-entity="basket-item-show-similar-link">-->
    <!--														{{/USE_FILTER}}-->
    <!--														--><?php //=Loc::getMessage('SBB_BASKET_ITEM_SIMILAR_P1')?><!--{{#USE_FILTER}}</a>{{/USE_FILTER}}-->
    <!--														--><?php //=Loc::getMessage('SBB_BASKET_ITEM_SIMILAR_P2')?>
    <!--														{{SIMILAR_ITEMS_QUANTITY}} {{MEASURE_TEXT}}-->
    <!--														<br>-->
    <!--														<a href="javascript:void(0)" class="basket-items-list-item-double-anchor"-->
    <!--															data-entity="basket-item-merge-sku-link">-->
    <!--															--><?php //=Loc::getMessage('SBB_BASKET_ITEM_SIMILAR_P3')?>
    <!--															{{TOTAL_SIMILAR_ITEMS_QUANTITY}} {{MEASURE_TEXT}}?-->
    <!--														</a>-->
    <!--													</div>-->
    <!--												</div>-->
    ...
    <!--					<div class="basket-item-block-price--><?php //=(!isset($mobileColumns['PRICE']) ? ' d-none d-sm-block' : '')?><!--">-->
    <!--						{{#SHOW_DISCOUNT_PRICE}}-->
    ...
    <!--							--><?php //=Loc::getMessage('SBB_BASKET_ITEM_PRICE_FOR')?><!-- {{MEASURE_RATIO}} {{MEASURE_TEXT}}-->
    <!--						</div>-->
    <!--						{{#SHOW_LOADING}}-->
    <!--							<div class="basket-items-list-item-overlay"></div>-->
    <!--						{{/SHOW_LOADING}}-->
    ...
    //			{
    //				?>
    <!--				<td class="basket-items-list-item-price--><?php //=(!isset($mobileColumns['SUM']) ? ' d-none d-sm-block' : '')?><!--">-->
    ...
    <!--								--><?php //=Loc::getMessage('SBB_BASKET_ITEM_ECONOMY')?>
