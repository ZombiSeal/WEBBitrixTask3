...
<head>
    ...
    <link rel="stylesheet" href="/korzina/korzina-test.css">
    <script src="/korzina/korzina-test.js" defer></script>
</head>
...
<div class="bx-wrapper" id="bx_eshop_wrap">
    ...
    <div class="workarea">
        <div class="container bx-content-section">
            <div class="row">
                <?$needSidebar = preg_match("~^".SITE_DIR."(catalog|personal\/cart|personal\/order\/make|korzina)/~", $curPage);?>
